...
const ProfilePopoverContent = React.forwardRef(
  ({ className, align = "center", sideOffset = 4, ...props }, ref) => (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ref={ref}
        ...
        {...props}
      >
        <div className="h-96 w-96 bg-white p-4 overflow-y-auto rounded-md shadow-md">
          {props.children}
        </div>
      </PopoverPrimitive.Content>
    </PopoverPrimitive.Portal>
...
ProfilePopoverContent.displayName = PopoverPrimitive.Content.displayName;

export { Popover, PopoverTrigger, PopoverContent, ProfilePopoverContent };
